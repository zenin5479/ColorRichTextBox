...
namespace ColorRichTextBox
{
   public partial class FormOne : Form
   {
      ...
      // Вывод текста заданного цвета и шрифта через метод TextColorMethodThree класса RichTextBoxColorMethod
      ...
      // Вывод текста заданного цвета через метод TextColorMethodFour класса RichTextBoxColorMethod
